...
void Roof1::generateMask(std::vector<std::vector<int>> tiles) {
...
void Roof1::generateParts(sf::Vector2i position, float scale) {
...
void Roof1::generateOverhang(sf::Vector2i position, float scale) {
