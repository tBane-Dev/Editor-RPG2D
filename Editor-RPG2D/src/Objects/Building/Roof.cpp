...
void GableRoof::generateShape(std::vector<std::vector<int>> tiles, sf::Vector2i position, float scale)
{
	float tileSize = 32.f * scale;
...
void GableRoof::generateTexture(std::vector<std::vector<int>> tiles, sf::Vector2i position, float scale)
{
	float tileSize = 32.f * scale;
