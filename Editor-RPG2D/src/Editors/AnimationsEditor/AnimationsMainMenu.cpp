...
AnimationsEditorMainMenu::AnimationsEditorMainMenu() : MainMenu() {
...
AnimationsEditorMainMenu::~AnimationsEditorMainMenu() {
	
}

void AnimationsEditorMainMenu::handleEvent(const sf::Event& event) {
